...
void picard_chebyshev_propagator(double* r0, double* v0, double t0, double t_final,double deg, double tol, double Period,
   ...
   std::vector<double> &P1, std::vector<double> &T1, std::vector<double> &A, std::vector<double> &Ta, std::vector<double> &W1, std::vector<double> &W2, double* Feval,
   std::vector<double> &ALPHA, std::vector<double> &segment_times, Orbit &orb, EphemerisManager ephem);
